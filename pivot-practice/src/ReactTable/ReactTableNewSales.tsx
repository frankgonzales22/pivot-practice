...
const ReactTableNewSales = () => {
    ...
    // const [Group, setGroup] = React.useState<GroupingState>([
    //     'territorycode'
    ...
    // const groupValue2 = rowItems.map(i => (Object.assign(groupValue, i._valuesCache)))
    // const cellItems = rowItems.map(i => (i._valuesCache, i.getLeafRows().length))
    ...
    // groupValue.push(cellItems as any)
    // console.log(groupValue.flat())
    // {console.log(rowItems.map)}
    // console.log(item)
